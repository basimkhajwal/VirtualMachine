...
public class CPU implements ICPU{
	...
	//BIT Masks
	private class MASKS{
		public static final int INT_TO_USHORT = 0x0000FFFF;
	}
	
	private class BITS{
		//Instruction bits
		public static final int INSTRUCTION_TYPE = 0;
	...
	private void execute(){
		if(getBit(currentInstruction, BITS.INSTRUCTION_TYPE)){
			...
			addressRegister = (short) (addressRegister >> 1);
